...
<body>
	...
	<form action="modify" method="post">
			...
			<div class="title">
				<dl>
					...
					<dd>
						...
						name="qTitle" required value="${qcontent_view.qTitle}" required>
						<input type="hidden" height="80" class="form-control" id="uId" placeholder="Title" 
						name="qId" required value="${qcontent_view.qId}" required>
					</dd>
				</dl>
			</div>
			<div class="info">
				...
				<dl>
					...
					<dd>
						...
						name="qName" required value="${qcontent_view.qNic}" readonly>	
					</dd>
				</dl>
			</div>
			<div class="cont">
				<textarea class="form-control" id="content" placeholder="내용 입력" name="qContent">
		...
		<div class="bt_wrap mb-5">
			<button type="submit" id="qmodi" class="btn btn-dark">수정 완료</button> 
